...
namespace FinalProject.Game
{
    class GameController
    {
        ...
        {
            Hero newHero = new Hero("Tom", 10, 5, 100, 5);
        ...
        public void HeroPicksItem(Item item)
        {
            ...
            if (item.type == 0)
            {
                ...
                Console.WriteLine("                                                     ");
                Console.SetCursorPosition(60, 6);
                Console.WriteLine("You picked a " + item.Name + ". You gained " + item.Health + " health.");
            }
            else if (item.type == 1)
            {
                ...
                Console.WriteLine("                                                     ");
                Console.SetCursorPosition(60, 6);
                Console.WriteLine("You picked a " + item.Name + ". Your attack increased by " + item.Attack + ".");
            }
            else if (item.type == 2)
            {
                hero.defence = hero.defence + item.defence;
                itemFunctions.DeleteItem(item);
                levelFunctions.ChangeCellInfo(levelFunctions.ReturnLevel(), itemFunctions.GetItemHorizontalPosition(item), itemFunctions.GetItemVerticalPosition(item), 1);
                Console.SetCursorPosition(60, 6);
                Console.WriteLine("                                                    ");
                Console.SetCursorPosition(60, 6);
                Console.WriteLine("You picked " + item.Name + ". Your defence increased by " + item.defence + ".");
            }
        }
    }
}
